...
import AISearchPageClientWrapper from '@/components/user/search-with-ai/AISearchPageClientWrapper';
...
async function getInitialSearchResults(
  ...
  const url = `${apiBaseUrl}/api/v1/properties/ai-search?${query.toString()}`;
