...
import ImageGallery, { GalleryImage } from '../../../components/user/listing/OldImageGallery';
...
const fetchProductDetailsAPI = async (id: number): Promise<ProductDetails | null> => {
  ...
  if (id > 0) {
    return {
      ...
      // ],
      galleryImages: [
        { id: 'img1', src: '/images/PropertyImagePlaceholder.png', alt: 'Property exterior', type: 'image' },
        { id: 'vid1', src: '/images/PropertyImagePlaceholder2.png', alt: 'Property video tour', type: 'video', videoSrc: '/videos/stock-video.mp4' },
        { id: 'img2', src: '/images/PropertyImagePlaceholder3.png', alt: 'Swimming pool area', type: 'image' },
        { id: 'img3', src: '/images/PropertyImagePlaceholder.png', alt: 'Living room interior', type: 'image' },
        { id: 'img4', src: '/images/PropertyImagePlaceholder2.png', alt: 'Modern bathroom', type: 'image' },
      ],
      agent: {
        name: 'John Doe',
        title: 'Lead Agent',
...
export async function generateMetadata(
  ...
  const url = "/api/v1/properties/" + id.toString();
  ...
  const product : IProperty = response.data.data;

  return {
    title: `${product.title} | TR Realty`,
    description: `Details for ${product.title}, located in ${product.location.street}.`,
    // openGraph: {
  ...
  return (
    <> {/* Or your main <Layout> component if it's compatible with Server Components */}
      ...
      <main className="container-fluid px-5 py-4 py-md-5">
        <div className="px-0">
          <div className="row g-4 g-lg-5">
            <div className="col-lg-7 col-md-12">
              <ImageGallery galleryImages={product.photos} />
            </div>
            ...
            <div className="col-lg-5 col-md-12 product-details-column">
              <ProductInfo
                ...
                location={product.location.street}
              />
              {/* <AgentCard
                agentName={product.creator.}
              ...
              */}
              ...
              {/* <AmenitiesGrid amenities={product.features} /> */}
            </div>
          </div>
        </div>
        ...
        {product.description && product.features && ( // Conditionally render if data exists
          <div className="mt-4 mt-lg-5"> {/* Add margin top to space from amenities */}
            <ProductDescription
              initialText={product.description} // Use the specific intro from your data
