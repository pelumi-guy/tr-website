...
import ErrorHandler from './utils/errorHandler.js'; // Assuming you have this custom error handler
 ...
 */
export const getStructuredSearchTerms = async(userQuery) => {
...
const userSearchQuery = "nice posh modern building in lekki with 3 floors triplets, a swimming pool and an open kitchen, not more than 80 million";
