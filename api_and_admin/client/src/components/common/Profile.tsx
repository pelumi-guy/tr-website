          ...
          <Box flex={1} display="flex" flexDirection={{ xs: 'column', md: 'row' }} gap="20px">
            ...
            <Box flex={1} display="flex" flexDirection="column" justifyContent="space-between" gap="30px">
              <Stack direction="column">
                ...
                <Typography fontSize={16} color="#808191">Real-Estate Direct Agent</Typography>
              </Stack>
              ...
              <Stack direction="column" gap="30px">
                <Stack gap="15px">
                  ...
                  <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                    ...
                    <Typography fontSize={14} color="#11142D">Philippines, Davao City</Typography>
                  </Box>
                </Stack>
    ...
    >
      ...
      >
        {properties?.map((property: PropertyProps) => (
          <PropertyCards
            key={property._id} id={property._id}
